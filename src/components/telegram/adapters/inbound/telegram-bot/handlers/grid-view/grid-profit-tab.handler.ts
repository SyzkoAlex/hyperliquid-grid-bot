...
import { GridProfitTabMessage } from '@components/telegram/core/domain/models/messages/grid-view/grid-profit-tab.message';
import { TelegramParseMode } from '@components/telegram/core/domain/models/telegram-parse-mode';
import { GridViewBaseHandler } from './grid-view-base.handler';

@Injectable()
export class GridProfitTabHandler extends GridViewBaseHandler {
    constructor(
    ...
    register(): void {
        this.telegramBotService.onAction(GridAction.VIEW_PATTERN, (ctx) => this.handle(ctx));
    }
