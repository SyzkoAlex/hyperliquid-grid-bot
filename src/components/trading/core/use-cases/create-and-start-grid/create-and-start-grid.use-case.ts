...
export class CreateAndStartGridUseCase {
    ...
    async execute(params: CreateAndStartGridParams): Promise<CreateAndStartGridResult> {
        ...
        const currentPrice = await this.orderClient.getCurrentPrice(Symbol.create(params.symbol));
    ...
    private async getUserBalanceAndCalculateCapital(
        ...
        const userState = await this.orderClient.getUserSpotState(params.address);
    ...
    private async createAndSaveGrid(
        ...
        const grid = Grid.create({
            symbol: Symbol.create(params.symbol),
            mode: params.mode,
