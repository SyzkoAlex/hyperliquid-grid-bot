...
/**
 * Integration Tests for HyperliquidOrderClientAdapter
 *
 ...
 */
describe('HyperliquidOrderClientAdapter (Integration)', () => {
    let client: HyperliquidOrderClientAdapter;
    let infoClient: HyperliquidInfoClientAdapter;
    ...
    async function initializeTestClient() {
        ...
        client = testingModule.get<HyperliquidOrderClientAdapter>(HyperliquidOrderClientAdapter);
        infoClient = testingModule.get<HyperliquidInfoClientAdapter>(HyperliquidInfoClientAdapter);
